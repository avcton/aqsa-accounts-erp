export default function BankPayment() {
    return (
        <div className="  flex flex-col items-center mt-15 justify-center overflow-auto h-screen w-screen bg-slate-50">
            <h3 className=" text-black text-3xl font-bold mt-10 mb-6 ">Bank Payment Voucher</h3>
            <form className="justify-center rounded-xl" onSubmit={null}>
                ...
                <div className="flex flex-col md:flex-row -mx-1">
                    ...
                    <div className="w-full px-3 py-3">
                        ...
                        <input className="appearance-textfield block w-full bg-gray-100 text-black border border-gray-300 rounded-lg py-4 px-4 mb-3 
                            leading-tight focus:outline-none focus:bg-gray-50 focus:border-gray-500" id="grid-card-number" type="text" placeholder="000" />
                    </div>
                </div>

                <div className="flex flex-row -mx-1 mb-6 justify-center">
                ...
                <div className="flex justify-center px-4 py-4">
                    <button className='px-4 py-2 bg-orange-400 font-semibold text-white rounded-lg'>Create Voucher</button>
                </div>
            </form>
        </div>
    )
