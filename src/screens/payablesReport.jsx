...
function createData(Date, Name, DueDate, BalanceDue, Payment1, invoiceNo) {
  return { Date, Name, DueDate, BalanceDue, Payment1, invoiceNo };
}

const rows = [
  createData('01-01-2023', 'Tripod', '12-12-2023', '$123', '$1'),
  createData('01-01-2023', 'Tripod', '12-12-2023', '$123', '$1'),
  createData('01-01-2023', 'Tripod', '12-12-2023', '$123', '$1'),
  createData('01-01-2023', 'Tripod', '12-12-2023', '$123', '$1'),
];
  ...
  return (
    <div className='flex flex-col h-screen w-screen align items-center justify-center bg-slate-50 overflow-auto'>
      <div className=' flex flex-col items-center justify-center '>
        <h3 className=" text-black text-3xl font-bold mb-6 ">Payables Report</h3>
          ...
          <Table sx={{ minWidth: 350 }} aria-label="customized table">
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell align="center">Payment1</StyledTableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {rows.map((row) => (
